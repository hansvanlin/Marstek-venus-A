...
\
The UI has 3 modes:\
<font color="green"> **1. Antifeed (soft limits):** using the Marstek own antifeed routine which keeps the P1 at zero (zero feedback, MOM) and keep the SOC within min and max set value's. </font>\
