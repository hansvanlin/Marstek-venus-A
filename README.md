...
\
Due to the discharge bug I changed to different way of controlling the batteries. From version 0.1.7 I'm using the Marstek schedule's which I can change via Modbus registers 43100-43104. These registers are written in one command thru the "Marstek Mode controller" node.
...
The controller creates a schedule entry by writing the following Modbus registers.

Register| Value| Description
43100| 127| Active days bitmask (127 = Monday-Sunday)
43101| 0| Start time (00:00)
43102| 2359| End time (23:59)
43103| Mode dependent| Power or control value
43104| 0 / 1| Schedule enable (0 = disabled, 1 = enabled)

Day Bitmask

Register 43100 uses a bitmask to determine on which days the schedule is active.

Value| Days
127| Monday-Sunday (all days)

Mode Values (Register 43103)

Input| Function| Register Value
0| Disabled| 64036
1| AntiFeed| 65535
...
A delay of 350 ms is inserted between writes for reliable operation.
